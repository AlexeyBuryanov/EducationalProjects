...
<!-- 
    Разработать сайт, обладающий следующим функционалом:
    + регистрация/вход на сайт
    + при регистрации создаётся новая папка, в которую будут помещаться картинки
    + добавление картинки с контролем расширения файла
    + просмотр только своих картинок при удачном входе в кабинет
    + удаление картинки при помощи radiobutton или checkbox
-->
            ...
            <main>
                ...
                <div class="main_content-wrap">
                    ...
                    <!-- 
                        ...
                        <form style="visibility: collapse; width: 0px; height: 0px;" id="formLogin" method="post" action="php/Login.php">
                            <label>E-mail: <input style="visibility: collapse;" type="text" id="emailPost" name="emailPost" /><br/><label/>
                            <label>Пароль: <input style="visibility: collapse;" type="text" id="passwordPost" name="passwordPost" /><br/><label/>
                        </form> 
                        $(function() {
                            $("button").bind("click", function() {
                                if ($(this).hasClass("btnLogin")) {
                                    $("#emailPost").val($("#email").val());
                                    $("#passwordPost").val($("#password").val());
                                    $("#formLogin").submit();
                                } // if
                            });
                        }); 
